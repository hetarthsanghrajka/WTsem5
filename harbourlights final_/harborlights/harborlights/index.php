<?php 
require 'db.php';
$query= "SELECT * FROM tbl_roomcategory where status=1";
								...
								<div class="form-group align-self-stretch d-flex align-items-end">
									<div class="wrap align-self-stretch py-3 px-4">
										<label for="#">Check-in Date</label>
											...
											placeholder="Check-in date" id="checkin_date" autocomplete="false">
									</div>
...
<!--         <form action="bookingform.php" method="POST">
            ...
            <center><a href="login.php" class="btn btn-success">Room Available, Want To Book?</a></center>
        <!-- </form> -->
                                    <?php
									...
									<div class="text p-4 text-center">
										...
										<?php
											if(empty($row['banquet'])){
												echo "<h5>Bedding: ".$row['beds']."</h5>";		
											}		
										?>
										
										<p class="pt-1"><a href="room-single.php?room_id=<?php echo $row['cid'] ?>" class="btn-custom px-3 py-2 rounded">View
