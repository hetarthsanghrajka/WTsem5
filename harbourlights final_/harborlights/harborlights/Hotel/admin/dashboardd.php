...
$s="SELECT count(*) as count FROM `tbl_booking` WHERE status=1";
    $sr= mysqli_query($con,$s);
    $c=  mysqli_fetch_array($sr);
 
    $noBooking= $c['count'];

    $s="SELECT count(*) as count FROM `tbl_employe`";
    $sr= mysqli_query($con,$s);
    $c=  mysqli_fetch_array($sr);

    $noEmployee= $c['count'];

    $s="SELECT count(*) as count FROM `users`";
    $sr= mysqli_query($con,$s);
    $c=  mysqli_fetch_array($sr);
