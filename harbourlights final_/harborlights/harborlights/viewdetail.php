...
session_start();
	require 'db.php';
	$id = $_GET['room_id'];
	$query= "SELECT * FROM tbl_roomcategory WHERE cid='$id'";
  $result=mysqli_query($con,$query);

  $query1= "SELECT * FROM tbl_room WHERE cid='$id' and status='1'";
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home</a></span> <span class="mr-2"><a href="rooms.php">Rooms</a></span> <span>Rooms Single</span></p>
          ...
          <div class="col-lg-8">
          	<div class="row">
          		...
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4"><?php echo $row['name'] ?><span>- ( Available rooms)</span></h2>
    						...
    						<div class="d-md-flex mt-5 mb-5">
	    						...
	    						<ul class="list ml-md-5">
	    							...
	    							<li><span>Bed:</span> <?php echo $row['beds'] ?></li>
	    						</ul>
    						</div>
              

                                                <p class="pt-1"><a href="bookingform.php?room_id=<?php echo $row['cid'] ?>" class="btn btn-success">Booking
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            Copyright <i class="icon-heart color-danger" aria-hidden="true"></i><a
              href="./Hotel/admin" target="_blank">Admin Login</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
          </div>
        </div>
